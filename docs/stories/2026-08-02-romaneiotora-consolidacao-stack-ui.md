...
- [ ] smoke local: listar/cadastrar/editar fornecedor e especie (validado em producao 12/08/2026: cadastro/edicao de fornecedor, cadastro de especie anos o fix do push-key; local bloqueado por auth do localhost)
